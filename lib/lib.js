      ...
      .on("end", () => {
        ...
        liArr.map((i, index) => {
          if (
            ...
            !i.attribs.href.includes("pinterest") &&
            !i.attribs.href.includes("tumblr") &&
            !i.attribs.href.includes("skype") &&
            !i.attribs.href.includes("apple") &&
            !i.attribs.href.includes("itunes") &&
            !i.attribs.href.includes("dallastheatercenter") &&
